export function setupAboutModal(button: HTMLElement, modal: HTMLElement): void {
  modal.innerHTML = `
    <div class="about-content">
      ...
      <p>This map shows monthly US county labor force change vs. <strong>January 2006</strong> across the 20-year window
      Jan 2006 – Dec 2025. Data is from the Bureau of Labor Statistics
